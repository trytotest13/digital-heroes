...
export async function runFullSeed(sql: postgres.Sql) {
  ...
  // 5. 58 Additional Players (player3 to player60)
  ...
  // 9. Historical Draws and Winners
  ...
  console.log("[Seed] Completed full database seed successfully!");
}
