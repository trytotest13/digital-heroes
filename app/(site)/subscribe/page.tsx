    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Reveal delay={200} className="h-full">
          <div className="card h-full p-6 transition duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_16px_36px_-16px_rgba(16,21,20,0.22)]">
            <p className="kicker">Monthly</p>
            <p className="mt-3 font-display text-[34px] font-bold text-ink">
              {inr(settings.monthly_price_pence)}
        ...
        <Reveal delay={300} className="h-full">
          <div className="card relative h-full p-6 ring-2 ring-pine transition duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_16px_36px_-16px_rgba(16,21,20,0.22)]">
            <span className="badge-amber absolute -top-3 left-6">Best value</span>
            <p className="kicker">Yearly</p>
            <p className="mt-3 font-display text-[34px] font-bold text-ink">
              {inr(settings.yearly_price_pence)}
              <span className="text-[14px] font-medium text-muted"> / year</span>
            </p>
            <ul className="mt-4 space-y-2 text-[14px] text-body">
              <li>· Everything in Monthly</li>
              <li>· Saves {inr(yearlySaving)} a year</li>
